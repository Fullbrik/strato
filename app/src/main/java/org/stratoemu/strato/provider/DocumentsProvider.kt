...
package org.stratoemu.strato.provider
...
class DocumentsProvider : DocumentsProvider() {
    private val baseDirectory = File(StratoApplication.instance.getPublicFilesDir().canonicalPath)
    private val applicationName = StratoApplication.instance.applicationInfo.loadLabel(StratoApplication.instance.packageManager).toString()

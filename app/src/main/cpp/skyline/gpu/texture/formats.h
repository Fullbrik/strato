...
namespace skyline::gpu::format {
    ...
    FORMAT(S8Uint, 8, eS8Uint, vka::eStencil, .swizzleMapping = {
    ...
    FORMAT(D24UnormX8Uint, 32, eX8D24UnormPack32, vka::eDepth, .swizzleMapping = {
           .r = vk::ComponentSwizzle::eR,
           .g = vk::ComponentSwizzle::eR,
           .b = vk::ComponentSwizzle::eB,
           .a = vk::ComponentSwizzle::eA
    });
    FORMAT(D24UnormS8Uint, 32, eD24UnormS8Uint, vka::eStencil | vka::eDepth, .swizzleMapping = {
           .r = vk::ComponentSwizzle::eR,
           .g = vk::ComponentSwizzle::eR,
           .b = vk::ComponentSwizzle::eB,
           .a = vk::ComponentSwizzle::eA
    });
    // FIXME: Due to guest and host format differences a special mechanism needs to be made for syncing this format
    FORMAT(D32FloatS8Uint, 32, eD32SfloatS8Uint, vka::eStencil | vka::eDepth, .swizzleMapping = {
           .r = vk::ComponentSwizzle::eR,
           .g = vk::ComponentSwizzle::eR,
           .b = vk::ComponentSwizzle::eB,
           .a = vk::ComponentSwizzle::eA
    ...
    // FIXME: Due to guest and host format differences a special mechanism needs to be made for syncing this format
    FORMAT(S8UintD24Unorm, 32, eD24UnormS8Uint, vka::eStencil | vka::eDepth, .swizzleMapping = {
           .r = vk::ComponentSwizzle::eR,
           .g = vk::ComponentSwizzle::eR,
           .b = vk::ComponentSwizzle::eB,
           .a = vk::ComponentSwizzle::eA

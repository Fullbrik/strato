...
namespace skyline::gpu::interconnect::node {
    ...
    struct RenderPassNode {
      private:
        ...
        vk::PipelineStageFlags selfDependencySrcStageMask{};
        vk::PipelineStageFlags selfDependencyDstStageMask{};
        vk::AccessFlags selfDependencySrcAccessMask{};
        vk::AccessFlags selfDependencyDstAccessMask{};
      ...
      public:
        ...
        void UpdateSelfDependency(vk::PipelineStageFlags srcStageMask, vk::PipelineStageFlags dstStageMask, vk::AccessFlags srcAccessMask, vk::AccessFlags dstAccessMask);
         ...
         */
        bool ClearColorAttachment(HostTextureView *view, const vk::ClearColorValue &value, GPU& gpu);
         ...
         * @note We require a subpass to be attached during this as the clear will not take place unless it's referenced by a subpass
         */
        bool ClearDepthStencilAttachment(HostTextureView *view, const vk::ClearDepthStencilValue &value, GPU& gpu);
    ...
    using NodeVariant = std::variant<FunctionNode, CheckpointNode, RenderPassNode, RenderPassEndNode, SyncNode>; //!< A variant encompassing all command nodes types
}
